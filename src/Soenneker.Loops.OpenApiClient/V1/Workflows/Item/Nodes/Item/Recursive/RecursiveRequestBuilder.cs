...
using System;
namespace Soenneker.Loops.OpenApiClient.V1.Workflows.Item.Nodes.Item.Recursive
{
    /// <summary>
    /// Builds and executes requests for operations under \v1\workflows\{workflowId}\nodes\{nodeId}\recursive
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class RecursiveRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Loops.OpenApiClient.V1.Workflows.Item.Nodes.Item.Recursive.RecursiveRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RecursiveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/workflows/{workflowId}/nodes/{nodeId}/recursive", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Loops.OpenApiClient.V1.Workflows.Item.Nodes.Item.Recursive.RecursiveRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RecursiveRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/workflows/{workflowId}/nodes/{nodeId}/recursive", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Loops.OpenApiClient.V1.Workflows.Item.Nodes.Item.Recursive.RecursiveRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Loops.OpenApiClient.V1.Workflows.Item.Nodes.Item.Recursive.RecursiveRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Loops.OpenApiClient.V1.Workflows.Item.Nodes.Item.Recursive.RecursiveRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
