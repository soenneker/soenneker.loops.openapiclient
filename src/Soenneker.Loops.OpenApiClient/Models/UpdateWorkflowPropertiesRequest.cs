...
namespace Soenneker.Loops.OpenApiClient.Models
{
    ...
    public partial class UpdateWorkflowPropertiesRequest : IParsable
    {
        /// <summary>The updated workflow description.</summary>
...
#nullable restore
        ...
        public string ExpectedRevisionId { get; set; }
#endif
        /// <summary>The updated workflow name.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Loops.OpenApiClient.Models.UpdateWorkflowPropertiesRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Loops.OpenApiClient.Models.UpdateWorkflowPropertiesRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Loops.OpenApiClient.Models.UpdateWorkflowPropertiesRequest();
        }
        /// <summary>
